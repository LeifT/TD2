 ...
 * Copyright © 2012-2016, by Flipbook Games
 * 
...
public class FavoritesTab : EditorWindow
{
	...
	private static bool _pushOtherIcons = EditorPrefs.GetBool("FlipbookGames.FavoritesTab.PushOtherIcons", true);
	...
	private static bool _showStars = EditorPrefs.GetBool("FlipbookGames.FavoritesTab.ShowStars", true);
